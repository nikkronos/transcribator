...
> **Число спикеров.** Авто-определение на длинных записях завышает число спикеров (дробит одного человека). Если знаешь, сколько людей в записи, — укажи это число: результат будет надёжным. По умолчанию стоит `2` (типичный созвон/интервью).
>
